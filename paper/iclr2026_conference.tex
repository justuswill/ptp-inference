...
three measures induce three different orderings: committing more tokens per call
is neither sufficient for lower latency nor compatible with staying faithful to
the reference.
\end{abstract}
