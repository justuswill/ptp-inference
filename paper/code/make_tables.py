...
MAIN = [
    ...
    ("ratio", "--"),
    ("ratio-10", r"$\kappa=10$"),
    ("entr-0.09-d0.3", r"$\epsilon=0.09$, $\delta=0.3$"),
    ("seq-ptp-entr-0.09-d0.3", r"$\epsilon=0.09$, $\delta=0.3$"),
...
PRETTY = {
    ...
    "entr-0.09-d0.3": "entropy-adaptive",
    "seq-ptp-entr-0.09-d0.3": "entropy-adaptive + PTP",
